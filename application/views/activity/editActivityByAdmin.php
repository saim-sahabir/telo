    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">  
                ...
                <!-- /.box-body -->
                <input type="hidden" name="user_id" value="<?php echo $actvt_info->user_id; ?>">

                <div class="box-footer">
                    <button type="submit" name="submit" value="submit" class="btn btn-primary">Submit</button>
                    <a href="<?php echo base_url() ?>Activity/allActivities"><button type="button" class="btn btn-primary">Back</button></a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
