...
<section class="content-header">
    <div class="row">
        <div class="col-md-6">
            <h2 class="top-left-header">Team Activities </h2>
        </div>
                                    ...
                                    <td> 
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">   
                                                <li>
                                                    <a href="<?php echo base_url() ?>Activity/editActivityByAdmin/<?php echo $this->custom->encrypt_decrypt($actvts->id, 'encrypt'); ?>" ><i class="fa fa-pencil tiny-icon"></i>Edit</a>
                                                </li>
                                                <li>
