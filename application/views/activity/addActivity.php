    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">  
                <!-- form start -->
                <?php echo form_open(base_url('Activity/addEditActivity')); ?>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="date" id="date" class="form-control" placeholder="Date" value="<?php echo date(dateFormatForPHP()); ?>">
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group"> 
                                ...
                                <select tabindex="2" class="form-control select2" id="project_id" name="project_id" style="width: 100%;">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="3" type="text" name="hour_spent" class="form-control" placeholder="Hour Spent" value="<?php echo set_value('hour_spent'); ?>">
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="4" class="form-control select2" id="status" name="status" style="width: 100%;">
                                    ...
                                    <option value="Initialized" <?php echo set_select('status', 'Initialized'); ?>>Initialized</option>
                                    <option value="In Progress" <?php echo set_select('status', 'In Progress'); ?>>In Progress</option> 
                                    <option value="Done" <?php echo set_select('status', 'Done'); ?>>Done</option> 
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea tabindex="5" class="form-control" rows="7" id="activity" name="activity" placeholder="Enter ..."><?php echo set_value('activity'); ?></textarea>
                            </div>
