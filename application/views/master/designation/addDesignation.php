...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary"> 
            <!-- form start -->
            <?php echo form_open(base_url('Master/addEditDesignation')); ?>
            <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input tabindex="1" type="text" name="designation_name" class="form-control" placeholder="Designation Name" value="<?php echo set_value('designation_name'); ?>">
                    </div>
