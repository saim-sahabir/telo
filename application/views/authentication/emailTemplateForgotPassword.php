                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="60" valign="top" class="header-cell">
                      <img width="196" height="60" src="<?php echo base_url(); ?>assets/images/tealo_logo.png" alt="logo">
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Your password has been reset by your request</h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hi <?php echo $first_name." ".$last_name; ?>,</b><br>
                            By your request we have created an auto generated password for you, please find below for the login URL and your login credentials with new password. (You can change this password after login)
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                        ...
                        <tr> 
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            Password: <?php echo $password?> <br><span style="font-size: 10px; color: gray;">You can change this password later</span>
                          </td>
                        </tr>
                        <tr>
                          <td>
