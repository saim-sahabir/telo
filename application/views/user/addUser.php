                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="first_name" class="form-control" placeholder="First Name" value="<?php echo set_value('first_name'); ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="2" type="text" name="last_name" class="form-control" placeholder="Last Name" value="<?php echo set_value('last_name'); ?>">
                            </div>
                            ...
                            <div class="form-group"> 
                                ...
                                <select tabindex="4" class="form-control select2" id="designation_id" name="designation_id" style="width: 100%;">
                                    ...
                                    <?php foreach ($designations as $dsgns) { ?>
                                        <option value="<?php echo $dsgns->id ?>" <?php echo set_select('designation_id', $dsgns->id); ?>><?php echo $dsgns->designation_name ?></option>
                                    <?php } ?>
                                </select>
                            </div> 
